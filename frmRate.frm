...
Private Sub Form_Load()
  XLeft = GetSetting(App.Title, "Config", "RX", Me.left)
  YTop = GetSetting(App.Title, "Config", "RY", Me.top)
  Me.Move XLeft, YTop
  txtRate = GetRate(AliasName)
End Sub

Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  SaveSetting App.Title, "Config", "RX", Str$(Me.left)
  SaveSetting App.Title, "Config", "RY", Str$(Me.top)
End Sub
